...
public class GuiMineralExtractorMk2 extends GuiContainer {

	private TileEntityMineralExtractorMK2 te;
    private static final ResourceLocation tex = new ResourceLocation(mod_Aps.textureName, "textures/guis/ExtractorGUIMk2.png");
	public GuiMineralExtractorMk2(ContainerMineralExtractorMk2 container) {
		super(container);
